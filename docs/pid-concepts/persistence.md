...
If the digital object should no longer be available, it is considered good practice to provide a [tombstone page](tombstone-pages.md) in place of the removed object, accessible through the PID. A tombstone page may contain metadata and information about when and why the object was withdrawn, if any other object has replaced it, etc.
